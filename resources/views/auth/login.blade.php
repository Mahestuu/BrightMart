...
<body>
    ...
    <div class="login-branding">
        <div class="brand-content">
            ...
            <p class="brand-subtitle">Silahkan login ke akun BrightMart Anda</p>
        ...
        <div class="login-form">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="text-center">
                    <p class="mb-0">Belum memiliki akun? <a href="{{ route('register') }}" class="text-decoration-none">Daftar
                            Sekarang</a></p>
                </div>
            </form>
        </div>
